...
<!-- URL_START -->
```
https://raw.githubusercontent.com/vishu786-vb/autoeq-repository-gen/main/RepositoryFiles/
```
<!-- URL_END -->
...
只需要简单地上传耳机的频率响应测量数据（CSV），就能自动化生成 PrecisEQ 专用的在线耳机校准仓库。校准 IR 使用 [AutoEq](https://github.com/jaakkopasanen/AutoEq) 生成。
